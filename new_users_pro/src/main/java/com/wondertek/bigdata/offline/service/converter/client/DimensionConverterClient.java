package com.wondertek.bigdata.offline.service.converter.client;
...
import com.wondertek.bigdata.offline.service.converter.server.DimensionConverterImpl;
...
// TODO: 2020.4.8 更改了ip和端口
        ...
        @Override
        public int getDimensionIdByValue(KeyBaseDimension dimension) throws IOException {
            /**
             * 创建cache的key值
             * 先从cache中通过key获取，如果cache中没有调用远程服务获取，并put到cache
             */
