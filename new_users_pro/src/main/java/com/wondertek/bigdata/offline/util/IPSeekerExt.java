...
import com.wondertek.bigdata.offline.util.ip.IPSeeker;
...
//    本地测试路径
//    private static final String ipFilePath = "C:\\Users\\Administrator\\Desktop\\qqwry.dat";

//    private static final String ipFilePath =IPSeekerExt.class.getResource("/qqwry.dat").getFile();

//    private static final String ipFilePath =IPSeekerExt.class.getResourceAsStream("/qqwry.dat").toString();
//    Linux运行路径
//    private static final String ipFilePath =File.separator + "home" +File.separator + "sjb.txt";
...
//    }
    ...
    public RegionInfo analysisIp(String ip) {
        ...
        if (ip != null && !"".equals(ip.trim())) {
            // ip不为空
            //解析运营商
            String isp=super.getIsp(ip);
            if (!ERROR_RESULT.equals(isp)) {
                info.setIsp(isp);
            }
...
//                    }
    ...
    public static class RegionInfo {
        ...
        //ISP运营商
        private String operator = GlobalConstants.DEFAULT_VALUE;
        ...
        public String toString() {
            return "RegionInfo [country=" + country + ", province=" + province + ", city=" + city+ ", operator=" + operator
                    + "]";
        }
    }
}
