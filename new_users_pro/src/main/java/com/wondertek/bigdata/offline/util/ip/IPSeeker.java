package com.wondertek.bigdata.offline.util.ip;
...
public class IPSeeker {
    ...
    protected IPSeeker() {
        ...
        try {
            //    本地测试路径
           String ipFilePath = "C:\\Users\\syf\\Desktop\\work\\qqwry.dat";
            //linux路径
        // String ipFilePath = File.separator + "home" +File.separator + "qqwry.dat";
    ...
    public String getIsp(String ip) {
        return getIsp(IPSeekerUtils.getIpByteArrayFromString(ip));
    }
    ...
    private IPLocation getIPLocation(long offset) {
        try {
            ...
            if (b == AREA_FOLLOWED) {
                ...
                // 读取地区标志
                loc.isp = readIsp(ipFile.getFilePointer());
            } else if (b == NO_AREA) {
                loc.country = readString(readLong3());
     ...
     * @throws IOException
     */
    private String readIsp(long offset) throws IOException {
        ipFile.seek(offset);
        byte b = ipFile.readByte();
        if (b == 0x01 || b == 0x02) {
            long ispOffset = readLong3(offset + 1);
            if (ispOffset == 0) {
                return "未知运营商";
            } else {
    ...
    public String getAddress(String ip) {
        ...
        String isp = " CZ88.NET".equals(getIsp(ip)) ? "" : getIsp(ip);
        String address = country + " " + isp;
        return address.trim();
    }
    ...
    public class IPEntry {
        ...
        public String toString() {
            return this.isp + " " + this.country + "IP  Χ:" + this.beginIp + "-" + this.endIp;
        }
    }
